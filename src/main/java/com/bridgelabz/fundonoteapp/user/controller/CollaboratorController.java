...
import com.bridgelabz.fundonoteapp.user.service.CollaboratorServiceInf;
...
public class CollaboratorController {
	...
	public ResponseEntity<String> addCollabarator(@PathVariable("token") String token,
	...
	public ResponseEntity<String> removeCollabarator(@PathVariable("token") String token,
			@RequestBody Collaborator collaborator, HttpServletRequest request, HttpServletResponse response) {
